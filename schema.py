...
class ToolsToUse(BaseModel):
    ...
    final_tool_to_use: Literal["find_places_nearby", "geocode_place", "TavilySearch", "no_tool"] = Field(description="The final apropriate tool to use for answering the user question.")
